...
export const RouterHelper = {
  ...
  administrator_user_detail_ref: (id: string | number) =>
    `/administrator/user-management/detail/${id}`,
  administrator_user_edit_ref: (id: string | number) =>
    `/administrator/user-management/edit/${id}`,

  administrator_organization_management:
    '/administrator/organization-management',
  administrator_organization_create:
    '/administrator/organization-management/create',
  administrator_organization_edit:
    '/administrator/organization-management/edit/:id',
  administrator_organization_edit_ref: (id: string) =>
    `/administrator/organization-management/edit/${id}`,
  ...
  product_management_add_product_ref: (id: string) =>
    `/product-management/product-add/${id}`,

  product_management_add: '/product-management/:id/add',
  product_management_add_ref: (id: string) => `/product-management/${id}/add`,

  product_management_product_group_add:
  ...
  product_group_edit_ref: (id: string) =>
  ...
  configuration_aither_connection_detail:
    '/configuration-aither-connection/edit/:id',
  configuration_aither_connection_detail_ref: (id: string) =>
    `/configuration-aither-connection/edit/${id}`,
  configuration_aither_connection_create:
    '/configuration/aither-connection/create',
  configuration_DMS_connection: '/configuration/dms-connection',
  configuration_DMS_connection_detail:
    '/configuration-fast-connection/edit/:id',
  configuration_DMS_connection_detail_ref: (id: string) =>
    `/configuration-fast-connection/edit/${id}`,
  ...
  configuration_mobile_app_detail_ref: (id: string) =>
    `/configuration-mobile-app/edit/${id}`,
